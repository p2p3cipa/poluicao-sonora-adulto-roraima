/* Service Worker — Poluição Sonora é Caso de Polícia (versão adulta)
   Guarda o folder inteiro no aparelho no primeiro acesso com internet,
   para que os acessos seguintes funcionem mesmo offline.
   Para publicar uma atualização, troque a versão do CACHE (ex.: poluicao-sonora-adulto-v2). */

const CACHE = 'poluicao-sonora-adulto-v1';

/* Tudo que o folder precisa para abrir sem internet (as fotos estão embutidas no index.html).
